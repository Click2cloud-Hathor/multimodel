...
#creating model
$openAIModel1 = az cognitiveservices account deployment create -g $rgName -n $openAIResource --deployment-name "text-embedding-ada-002" --model-name "text-embedding-ada-002" --model-version "2" --model-format OpenAI --sku-capacity 10 --sku-name "Standard"
...
write-host "Regitering OpenAI text-embedding-ada-002 as external model..."
    ...
    "served_entities": [
      {
        ...
        "external_model": {
          ...
          "openai_config": {
            "openai_api_key": "{{secrets/databricks-scope/openai-key}}",
